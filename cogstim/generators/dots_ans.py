...
class DotsANSGenerator(BaseGenerator):
    ...
    def create_and_save(self, n1, n2, equalized, phase, tag=""):
        ...
        ext = get_file_extension(self.config["img_format"])
        name = f"img_{n1}_{n2}_{tag}{eq}{v_tag}.{ext}"
    ...
    def create_and_save_once(self, name, n1, n2, equalized, phase):
        ...
        img_format = self.config.get("img_format", "png").lower()
        ...
        save_image(img, save_path, img_format)
